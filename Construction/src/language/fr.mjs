export const language = {
    ...
    'MODIFIER_DATA_spoof_AddWeaponMasteryMelee': "Débloquer la maîtrise des armes de mêlée",
    'MODIFIER_DATA_spoof_AddWeaponMasteryRanged': "Débloquer la maîtrise des armes à distance ×",
    'MODIFIER_DATA_spoof_AddWeaponMasteryMagic': "Débloquer la maîtrise des armes magiques ×",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMelee': "Augmenter le niveau max de maîtrise des armes de mêlée",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelRanged': "Augmenter le niveau max de maîtrise des armes à distance",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMagic': "Augmenter le niveau max de maîtrise des armes magiques",
    'MODIFIER_DATA_spoof_AddIndBonusMelee': 'Débloquer les bonus individuels pour les armes de mêlée',
    'MODIFIER_DATA_spoof_AddIndBonusRanged': 'Débloquer les bonus individuels pour les armes à distance',
    'MODIFIER_DATA_spoof_AddIndBonusMagic': 'Débloquer les bonus individuels pour les armes magiques',
    ...
    'MODIFIER_DATA_spoof_DoubleIndBonusMelee': "+50% d'efficacité des bonus individuels pour les armes de mêlée",
    'MODIFIER_DATA_spoof_DoubleIndBonusRanged': "+50% d'efficacité des bonus individuels pour les armes à distance",
    'MODIFIER_DATA_spoof_DoubleIndBonusMagic': "+50% d'efficacité des bonus individuels pour les armes magiques",
...
'MODIFIER_DATA_blockTheUnblockable': '${value}% de la chance de rater de l\'ennemi comme chance d\'annuler les attaques inévitables',
    ...
    "ITEM_NAME_Iron_Crossbow_T_R": "(R) Arbalète en fer",
    "ITEM_NAME_Steel_Crossbow_T_R": "(R) Arbalète en acier",
    "ITEM_NAME_Mithril_Crossbow_T_R": "(R) Arbalète en mithril",
    "ITEM_NAME_Adamant_Crossbow_T_R": "(R) Arbalète en adamantite",
    "ITEM_NAME_Rune_Crossbow_T_R": "(R) Arbalète runique",
    "ITEM_NAME_Dragon_Crossbow_T_R": "(R) Arbalète de dragon",
    "ITEM_NAME_Green_Dhide_Shield_R": "(R) Bouclier en cuir de dragon vert",
    "ITEM_NAME_Blue_Dhide_Shield_R": "(R) Bouclier en cuir de dragon bleu",
    "ITEM_NAME_Red_Dhide_Shield_R": "(R) Bouclier en cuir de dragon rouge",
    "ITEM_NAME_Black_Dhide_Shield_R": "(R) Bouclier en cuir de dragon noir",
    "ITEM_NAME_Ancient_Dhide_Shield_R": "(R) Bouclier en cuir de dragon ancien",
    "MODIFIER_DATA_decrease_skillEfficiencyChance": "-${value}% de chances d'effectuer des actions supplémentaires",
    "MODIFIER_DATA_increase_skillEfficiencyChance": "+${value}% de chances d'effectuer des actions supplémentaires",
    "MODIFIER_DATA_skillEfficiencyChancePerHamrielStar": "${value}% de chances d'effectuer des actions supplémentaires par étoile maxée dans la constellation d'Haemir en Astrologie",
    "MODIFIER_DATA_decrease_skillEfficiencyPotencyForCategory": "-${value} matériaux ou progression supplémentaire lors d'actions supplémentaires en fabriquant : ${categoryName}",
    "MODIFIER_DATA_increase_skillEfficiencyPotencyForCategory": "+${value} matériaux ou progression supplémentaire lors d'actions supplémentaires en fabriquant : ${categoryName}",
    "MODIFIER_DATA_bypassEfficiencyChance": "${value}% de chances d'effectuer des actions supplémentaires (outrepasse les limitations du mode de jeu)",
    "MODIFIER_DATA_unlockEfficiencySkill": "Débloque la capacité d'effectuer des actions supplémentaires en ${skillName}",
    "MODIFIER_DATA_spoofUpgradeCross": "Débloque la capacité de renforcer les arbalètes fabriquées en Archerie",
    "MODIFIER_DATA_spoofUpgradeShields": "Débloque la capacité de renforcer les boucliers fabriqués en Artisanat",
    "MODIFIER_DATA_2turnstunoncritchance": "${value}% de chances d'étourdir l'ennemi pendant 2 tours lors d'un coup critique",
    "MODIFIER_DATA_skillScopedPoolCap": "+${value}% à la limite d'XP de la réserve de maîtrise en ${skillName}",
    "MODIFIER_DATA_spoofAddNewMPBonus": "${value} paliers de réserve de maîtrise en ${skillName}",
    "MODIFIER_DATA_spoofAddConsToSmithingPool": "Ajoute les modificateurs de Construction aux paliers de réserve de maîtrise de la Forge",
    "MODIFIER_DATA_findChuckOnFixtureComp": "Faible chance de trouver Chuck en terminant un meuble",
    "MODIFIER_DATA_maxlevelAssocbonusEff": "${value}% de chances d'effectuer des actions supplémentaires en construisant des meubles si les compétences associées sont de niveau ≥ 99",

    'MODIFIER_DATA_skillItemDoublingChanceGlobal': '${value}% de chance de doubler les objets dans les compétences',

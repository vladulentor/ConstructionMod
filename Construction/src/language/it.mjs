export const language = {
    'MODIFIER_DATA_spoof_AddWeaponMasteryMelee': "Sblocca la maestria nelle armi da mischia",
    'MODIFIER_DATA_spoof_AddWeaponMasteryRanged': "Sblocca la maestria nelle armi a distanza ×",
    'MODIFIER_DATA_spoof_AddWeaponMasteryMagic': "Sblocca la maestria nelle armi magiche ×",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMelee': "Aumenta il livello massimo di maestria nelle armi da mischia",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelRanged': "Aumenta il livello massimo di maestria nelle armi a distanza",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMagic': "Aumenta il livello massimo di maestria nelle armi magiche",
    'MODIFIER_DATA_spoof_AddIndBonusMelee': 'Sblocca i bonus individuali per le armi da mischia',
    'MODIFIER_DATA_spoof_AddIndBonusRanged': 'Sblocca i bonus individuali per le armi a distanza',
    'MODIFIER_DATA_spoof_AddIndBonusMagic': 'Sblocca i bonus individuali per le armi magiche',
    'MODIFIER_DATA_increaseWeaponXPMelee': "${value}% di PE maestria armi da mischia",
    'MODIFIER_DATA_increaseWeaponXPRanged': "${value}% di PE maestria armi a distanza",
    'MODIFIER_DATA_increaseWeaponXPMagic': "${value}% di PE maestria armi magiche",
    'MODIFIER_DATA_spoof_DoubleIndBonusMelee': "+50% all'efficacia dei bonus individuali per le armi da mischia",
    'MODIFIER_DATA_spoof_DoubleIndBonusRanged': "+50% all'efficacia dei bonus individuali per le armi a distanza",
    'MODIFIER_DATA_spoof_DoubleIndBonusMagic': "+50% all'efficacia dei bonus individuali per le armi magiche",
...
'MODIFIER_DATA_blockTheUnblockable': '${value}% della probabilità di mancato del nemico come probabilità di negare attacchi inevitabili',
    ...
    "ITEM_NAME_Iron_Crossbow_T_R": "(R) Balestra di ferro",
    "ITEM_NAME_Steel_Crossbow_T_R": "(R) Balestra d'acciaio",
    "ITEM_NAME_Mithril_Crossbow_T_R": "(R) Balestra di mithril",
    "ITEM_NAME_Adamant_Crossbow_T_R": "(R) Balestra di adamantio",
    "ITEM_NAME_Rune_Crossbow_T_R": "(R) Balestra runica",
    "ITEM_NAME_Dragon_Crossbow_T_R": "(R) Balestra di drago",
    "ITEM_NAME_Green_Dhide_Shield_R": "(R) Scudo in pelle di drago verde",
    "ITEM_NAME_Blue_Dhide_Shield_R": "(R) Scudo in pelle di drago blu",
    "ITEM_NAME_Red_Dhide_Shield_R": "(R) Scudo in pelle di drago rosso",
    "ITEM_NAME_Black_Dhide_Shield_R": "(R) Scudo in pelle di drago nero",
    "ITEM_NAME_Ancient_Dhide_Shield_R": "(R) Scudo in pelle di drago antico",
    "MODIFIER_DATA_decrease_skillEfficiencyChance": "-${value}% di probabilità di completare azioni extra",
    "MODIFIER_DATA_increase_skillEfficiencyChance": "+${value}% di probabilità di completare azioni extra",
    "MODIFIER_DATA_skillEfficiencyChancePerHamrielStar": "${value}% di probabilità di completare azioni extra per ogni stella massimizzata nella costellazione di Haemir in Astrologia",
    "MODIFIER_DATA_decrease_skillEfficiencyPotencyForCategory": "-${value} materiali o progressi extra ottenuti completando azioni extra durante la creazione di ${categoryName}",
    "MODIFIER_DATA_increase_skillEfficiencyPotencyForCategory": "+${value} materiali o progressi extra ottenuti completando azioni extra durante la creazione di ${categoryName}",
    "MODIFIER_DATA_bypassEfficiencyChance": "${value}% di probabilità di completare azioni extra (ignora le limitazioni della modalità di gioco)",
    "MODIFIER_DATA_unlockEfficiencySkill": "Sblocca la possibilità di completare azioni extra in ${skillName}",
    "MODIFIER_DATA_spoofUpgradeCross": "Sblocca la possibilità di rinforzare le balestre create in Fletching",
    "MODIFIER_DATA_spoofUpgradeShields": "Sblocca la possibilità di rinforzare gli scudi creati in Crafting",
    "MODIFIER_DATA_2turnstunoncritchance": "${value}% di probabilità di stordire il nemico per 2 turni con un colpo critico",
    "MODIFIER_DATA_skillScopedPoolCap": "+${value}% al limite PE della riserva di maestria in ${skillName}",
    "MODIFIER_DATA_spoofAddNewMPBonus": "${value} traguardi della riserva di maestria in ${skillName}",
    "MODIFIER_DATA_spoofAddConsToSmithingPool": "Aggiunge i modificatori di Costruzione ai traguardi della riserva di maestria di Forgiatura",
    "MODIFIER_DATA_findChuckOnFixtureComp": "Piccola probabilità di trovare Chuck terminando l'arredamento",
    "MODIFIER_DATA_maxlevelAssocbonusEff": "${value}% di probabilità di completare azioni extra costruendo arredamento se le abilità associate sono di livello ≥ 99",

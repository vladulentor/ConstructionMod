export const language = {
    'MODIFIER_DATA_spoof_AddWeaponMasteryMelee': "近接武器タイプの熟練度を解放",
    'MODIFIER_DATA_spoof_AddWeaponMasteryRanged': "遠距離武器タイプの熟練度 × を解放",
    'MODIFIER_DATA_spoof_AddWeaponMasteryMagic': "魔法武器タイプの熟練度 × を解放",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMelee': "近接武器タイプの熟練度上限レベルを上昇",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelRanged': "遠距離武器タイプの熟練度上限レベルを上昇",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMagic': "魔法武器タイプの熟練度上限レベルを上昇",
    'MODIFIER_DATA_spoof_AddIndBonusMelee': '近接武器の個別ボーナスを解放',
    'MODIFIER_DATA_spoof_AddIndBonusRanged': '遠距離武器の個別ボーナスを解放',
    'MODIFIER_DATA_spoof_AddIndBonusMagic': '魔法武器の個別ボーナスを解放',
    'MODIFIER_DATA_increaseWeaponXPMelee': "近接武器熟練度XP +${value}%",
    'MODIFIER_DATA_increaseWeaponXPRanged': "遠距離武器熟練度XP +${value}%",
    'MODIFIER_DATA_increaseWeaponXPMagic': "魔法武器熟練度XP +${value}%",
    'MODIFIER_DATA_spoof_DoubleIndBonusMelee': "近接武器の個別ボーナス効果 +50%",
    'MODIFIER_DATA_spoof_DoubleIndBonusRanged': "遠距離武器の個別ボーナス効果 +50%",
    'MODIFIER_DATA_spoof_DoubleIndBonusMagic': "魔法武器の個別ボーナス効果 +50%",
    'MODIFIER_DATA_GlobalEffectIgnoreChance': 'すべての戦闘効果を無視する確率 ${value}%',
    'MODIFIER_DATA_itemProtectionChance': '死亡時にアイテムを失わない確率 ${value}%',
...
'MODIFIER_DATA_blockTheUnblockable': '敵の空振り確率の${value}%を、回避不能な攻撃を無効化する確率として適用',
    'SPLASH_NEGATED': '無効化！',
    ...
    "ITEM_NAME_Iron_Crossbow_T_R": "(R) 鉄のクロスボウ",
    "ITEM_NAME_Steel_Crossbow_T_R": "(R) 鋼のクロスボウ",
    "ITEM_NAME_Mithril_Crossbow_T_R": "(R) ミスリルのクロスボウ",
    "ITEM_NAME_Adamant_Crossbow_T_R": "(R) アダマントのクロスボウ",
    "ITEM_NAME_Rune_Crossbow_T_R": "(R) ルーンのクロスボウ",
    "ITEM_NAME_Dragon_Crossbow_T_R": "(R) ドラゴンのクロスボウ",
    "ITEM_NAME_Green_Dhide_Shield_R": "(R) 緑竜革の盾",
    "ITEM_NAME_Blue_Dhide_Shield_R": "(R) 青竜革の盾",
    "ITEM_NAME_Red_Dhide_Shield_R": "(R) 赤竜革の盾",
    "ITEM_NAME_Black_Dhide_Shield_R": "(R) 黒竜革の盾",
    "ITEM_NAME_Ancient_Dhide_Shield_R": "(R) 古代竜革の盾",
    "MODIFIER_DATA_decrease_skillEfficiencyChance": "追加アクションが発生する確率 -${value}%",
    "MODIFIER_DATA_increase_skillEfficiencyChance": "追加アクションが発生する確率 +${value}%",
    "MODIFIER_DATA_skillEfficiencyChancePerHamrielStar": "占星術のヘイミール座で最大になった星1つにつき、追加アクションが発生する確率 +${value}%",
    "MODIFIER_DATA_decrease_skillEfficiencyPotencyForCategory": "${categoryName} の作成中、追加アクション発生時の追加素材または進行度 -${value}",
    "MODIFIER_DATA_increase_skillEfficiencyPotencyForCategory": "${categoryName} の作成中、追加アクション発生時の追加素材または進行度 +${value}",
    "MODIFIER_DATA_bypassEfficiencyChance": "追加アクションが発生する確率 ${value}% (ゲームモードの制限を無視)",
    "MODIFIER_DATA_unlockEfficiencySkill": "${skillName} で追加アクションを行う能力をアンロック",
    "MODIFIER_DATA_spoofUpgradeCross": "矢作りで作成したクロスボウを強化する能力をアンロック",
    "MODIFIER_DATA_spoofUpgradeShields": "手細工で作成した盾を強化する能力をアンロック",
    "MODIFIER_DATA_2turnstunoncritchance": "クリティカルヒット時、${value}% の確率で敵を2ターンの間スタンさせる",
    "MODIFIER_DATA_skillScopedPoolCap": "${skillName} のマスタリープールXP上限 ${value}%",
    "MODIFIER_DATA_spoofAddNewMPBonus": "${skillName} のマスタリープール・チェックポイント ${value}",
    "MODIFIER_DATA_spoofAddConsToSmithingPool": "鍛冶のマスタリープール・チェックポイントに建設の修正値を加える",
    "MODIFIER_DATA_findChuckOnFixtureComp": "家具の完成時に低確率でチャックを見つける",
    "MODIFIER_DATA_maxlevelAssocbonusEff": "家具の作成時、関連スキルのレベルが99以上であれば、${value}% の確率で追加アクションが発生する",
    'MODIFIER_DATA_skillItemDoublingChanceGlobal': 'スキルでアイテムを2倍にする確率 ${value}%',

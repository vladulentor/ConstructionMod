...
'SHOP_DESCRIPTION_Dragon_Saw': 'Интервал строительства -10% (всего -40% от пилы). +0.30 к дополнительным материалам или прогрессу при выполнении дополнительных действий (всего +1.50 от пилы).',
    ...
    'ITEM_NAME_Magic_Beams': 'Волшебные балки',
    ...
    'ITEM_NAME_Flower_Pots_Token_1': 'Постройте Цветочные Горшки Уровня 1 в разделе Строительство, чтобы разблокировать.',
    'ITEM_NAME_Flower_Pots_Token_2': 'Постройте Цветочные Горшки Уровня 2 в разделе Строительство, чтобы разблокировать.',
    'ITEM_NAME_Flower_Pots_Token_3': 'Постройте Цветочные Горшки Уровня 3 в разделе Строительство, чтобы разблокировать.',
    'ITEM_NAME_Flower_Pots_Token_4': 'Постройте Цветочные Горшки Уровня 4 в разделе Строительство, чтобы разблокировать.',
    'ITEM_NAME_Flower_Pots_Token_5': 'Постройте Цветочные Горшки Уровня 5 в разделе Строительство, чтобы разблокировать.',

export const language = {
    'MODIFIER_DATA_spoof_AddWeaponMasteryMelee': "解锁近战武器类型精通",
    'MODIFIER_DATA_spoof_AddWeaponMasteryRanged': "解锁远程武器类型精通 ×",
    'MODIFIER_DATA_spoof_AddWeaponMasteryMagic': "解锁魔法武器类型精通 ×",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMelee': "提高近战武器类型最大精通等级",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelRanged': "提高远程武器类型最大精通等级",
    'MODIFIER_DATA_spoof_IncreaseMasteryLevelMagic': "提高魔法武器类型最大精通等级",
    'MODIFIER_DATA_spoof_AddIndBonusMelee': '解锁近战武器单项加成',
    'MODIFIER_DATA_spoof_AddIndBonusRanged': '解锁远程武器单项加成',
    'MODIFIER_DATA_spoof_AddIndBonusMagic': '解锁魔法武器单项加成',
    'MODIFIER_DATA_increaseWeaponXPMelee': "近战武器精通经验值 +${value}%",
    'MODIFIER_DATA_increaseWeaponXPRanged': "远程武器精通经验值 +${value}%",
    'MODIFIER_DATA_increaseWeaponXPMagic': "魔法武器精通经验值 +${value}%",
    'MODIFIER_DATA_spoof_DoubleIndBonusMelee': "近战武器单项加成效果 +50%",
    'MODIFIER_DATA_spoof_DoubleIndBonusRanged': "远程武器单项加成效果 +50%",
    'MODIFIER_DATA_spoof_DoubleIndBonusMagic': "魔法武器单项加成效果 +50%",
    'MODIFIER_DATA_GlobalEffectIgnoreChance': '有 ${value}% 的几率无视所有战斗效果',
    'MODIFIER_DATA_itemProtectionChance': '死亡时有 ${value}% 的几率不丢失物品',
...
'MODIFIER_DATA_blockTheUnblockable': '将敌人攻击落空几率的 ${value}% 转化为无视“无法回避”攻击的几率',
    'SPLASH_NEGATED': '无效化！',
    ...
    "ITEM_NAME_Iron_Crossbow_T_R": "(R) 铁弩",
    "ITEM_NAME_Steel_Crossbow_T_R": "(R) 钢弩",
    "ITEM_NAME_Mithril_Crossbow_T_R": "(R) 秘银弩",
    "ITEM_NAME_Adamant_Crossbow_T_R": "(R) 精金弩",
    "ITEM_NAME_Rune_Crossbow_T_R": "(R) 符文弩",
    "ITEM_NAME_Dragon_Crossbow_T_R": "(R) 龙弩",
    "ITEM_NAME_Green_Dhide_Shield_R": "(R) 绿龙皮盾",
    "ITEM_NAME_Blue_Dhide_Shield_R": "(R) 蓝龙皮盾",
    "ITEM_NAME_Red_Dhide_Shield_R": "(R) 红龙皮盾",
    "ITEM_NAME_Black_Dhide_Shield_R": "(R) 黑龙皮盾",
    "ITEM_NAME_Ancient_Dhide_Shield_R": "(R) 古龙皮盾",
    "MODIFIER_DATA_decrease_skillEfficiencyChance": "完成额外动作的几率 -${value}%",
    "MODIFIER_DATA_increase_skillEfficiencyChance": "完成额外动作的几率 +${value}%",
    "MODIFIER_DATA_skillEfficiencyChancePerHamrielStar": "占星学中海米尔座每颗满级星星增加 ${value}% 完成额外动作的几率",
    "MODIFIER_DATA_decrease_skillEfficiencyPotencyForCategory": "制作 ${categoryName} 时，完成额外动作获得的额外材料或进度 -${value}",
    "MODIFIER_DATA_increase_skillEfficiencyPotencyForCategory": "制作 ${categoryName} 时，完成额外动作获得的额外材料或进度 +${value}",
    "MODIFIER_DATA_bypassEfficiencyChance": "有 ${value}% 几率完成额外动作（无视游戏模式限制）",
    "MODIFIER_DATA_unlockEfficiencySkill": "解锁在 ${skillName} 中完成额外动作的能力",
    "MODIFIER_DATA_spoofUpgradeCross": "解锁强化弩箭制作中产出的弩的能力",
    "MODIFIER_DATA_spoofUpgradeShields": "解锁强化工艺制作中产出的盾牌的能力",
    "MODIFIER_DATA_2turnstunoncritchance": "暴击时有 ${value}% 几率使敌人眩晕 2 回合",
    "MODIFIER_DATA_skillScopedPoolCap": "${skillName} 的大师技能池经验上限 ${value}%",
    "MODIFIER_DATA_spoofAddNewMPBonus": "${skillName} 的大师技能池检查点 ${value}",
    "MODIFIER_DATA_spoofAddConsToSmithingPool": "将建筑修正项添加至锻造的大师技能池检查点",
    "MODIFIER_DATA_findChuckOnFixtureComp": "完成家具制作时有小几率找到查克（Chuck）",
    "MODIFIER_DATA_maxlevelAssocbonusEff": "制作家具时，若相关技能等级 ≥ 99，则有 ${value}% 几率完成额外动作",
    'MODIFIER_DATA_skillItemDoublingChanceGlobal': '在技能中物品翻倍的概率 ${value}%',

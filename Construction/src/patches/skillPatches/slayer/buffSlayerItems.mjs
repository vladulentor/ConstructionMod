const itemUpgrades = [
    ...
    { item: "melvorF:Desert_Hat", upgrades: [{ key: 'rangedAttackBonus', value: 5 }, { key: 'magicAttackBonus', value: 20 }, { key: 'meleeStrengthBonus', value: 15 }, { key: 'meleeDefenceBonus', value: 15 }, { key: "damageReduction", value: 1 }] },
    ...
    { item: "melvorF:Climbing_Boots", upgrades: [{ key: 'meleeStrengthBonus', value: 18 }, { key: 'meleeDefenceBonus', value: 15 }, { key: "damageReduction", value: 2 }] },
    ...
    { item: "melvorF:Slayer_Skillcape", upgrades: [{ key: 'meleeDefenceBonus', value: 15 }, { key: 'rangedDefenceBonus', value: 15 }, { key: 'magicDefenceBonus', value: 15 }, { key: "damageReduction", value: 2 }] },
    { item: "melvorTotH:Superior_Slayer_Skillcape", upgrades: [{ key: 'meleeDefenceBonus', value: 25 }, { key: 'rangedDefenceBonus', value: 25 }, { key: 'magicDefenceBonus', value: 25 }, { key: "damageReduction", value: 3 }] }

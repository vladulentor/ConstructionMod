(function(e, t) {
    ...
    function H(e, t, n, r) {
        this._e = U(), this.failures = t, this.failedKeys = r, this.successCount = n, this.message = G(e, t)
    }

    function Q(e, t) {
        this._e = U(), this.name = "BulkError", this.failures = Object.keys(t).map(function(e) {
            return t[e]
        }), this.failuresByPos = t, this.message = G(e, t)
    }
    o(Y).from(Error).extend({
        stack: {
            get: function() {
    ...
    }), o(H).from(Y), o(Q).from(Y);
    var e = L.reduce(function(e, t) {
            return e[t] = t + "Error", e
        }, {}),
        X = Y,
        J = L.reduce(function(e, n) {
            var r = n + "Error";

            function t(e, t) {
                this._e = U(), this.name = r, e ? "string" == typeof e ? (this.message = e + (t ? "\n " + t : ""), this.inner = t || null) : "object" == typeof e && (this.message = e.name + " " + e.message, this.inner = e) : (this.message = z[n] || r, this.inner = null)
            }
    ...
    W.ModifyError = H, W.DexieError = Y, W.BulkError = Q;
    var se = {},
        ce = 100,
        le = 100,
        L = "undefined" == typeof Promise ? [] : function() {
    ...
    function je(e) {
        ...
        if (F && (this._stackHolder = U(), this._prev = null, this._numPrev = 0), "function" != typeof e) {
            ...
            return this._state = arguments[1], this._value = arguments[2], void(!1 === this._state && Ie(this, this._value))
        }
            ...
            function e(n, r) {
                var i = this,
                    ...
                    e = new je(function(e, t) {
                        Re(i, new Be(at(n, u, o, a), at(r, u, o, a), e, t, u))
                    });
    ...
    r(je.prototype, {
        then: De,
        _then: function(e, t) {
            Re(this, new Be(null, null, e, t, Oe))
        },
        catch: function(e) {
            ...
            return "function" == typeof t ? this.then(null, function(e) {
                return (e instanceof t ? n : We)(e)
            }) : this.then(null, function(e) {
                return (e && e.name === t ? n : We)(e)
            })
        },
        finally: function(t) {
            ...
            get: function() {
                ...
                try {
                    ...
                    var e = function e(t, n, r) {
                        ...
                        var i = ""; {
                            var o, a, u;
                            !1 === t._state && (null != (o = t._value) ? (a = o.name || "Error", u = o.message || o, i = V(o, 0)) : (a = o, u = ""), n.push(a + (u ? ": " + u : "") + i))
                        }
                        F && ((i = V(t._stackHolder, 2)) && -1 === n.indexOf(i) && n.push(i), t._prev && e(t._prev, n, r));
                        return n
                    }(this, [], 20).join("\nFrom previous: ");
    ...
    var Pt = (Kt.prototype._trans = function(e, r, t) {
        ...
        try {
            return n && n.db === this.db ? n === Oe.trans ? n._promise(e, o, t) : Je(function() {
                ...
                if (t._state.openComplete) return lt(new J.DatabaseClosed(t._state.dbOpenError));
                if (!t._state.isBeingOpened) {
                    if (!t._options.autoOpen) return lt(new J.DatabaseClosed);
                    t.open().catch(Z)
                }
        ...
        return this._trans("readwrite", function(e) {
            ...
            return o.core.mutate({
                ...
                var t = e.numFailures,
                    ...
                    e = e.failures;
                if (0 === t) return u ? n : r;
                throw new Q(o.name + ".bulkAdd(): " + t + " of " + i + " operations failed", e)
            })
        })
        ...
        return this._trans("readwrite", function(e) {
            ...
            return o.core.mutate({
                ...
                var t = e.numFailures,
                    ...
                    e = e.failures;
                if (0 === t) return u ? n : r;
                throw new Q(o.name + ".bulkPut(): " + t + " of " + i + " operations failed", e)
            })
        })
        ...
        return this._trans("readwrite", function(e) {
            ...
            var t = e.numFailures,
                ...
                e = e.failures;
            if (0 === t) return n;
            throw new Q(r.name + ".bulkDelete(): " + t + " of " + i + " operations failed", e)
        })
    }, Kt);
    ...
    function It(e, o, t, n) {
        ...
        if (e.or) {
            ...
            return Promise.all([e.or._iterate(r, t), Tt(Bt(e, n, t), e.algorithm, r, !e.keysOnly && e.valueMapper)])
        }
        return Tt(Bt(e, n, t), xt(e.algorithm, a), o, !e.keysOnly && e.valueMapper)
    }

    function Tt(e, r, i, o) {
        var a = Le(o ? function(e, t, n) {
            return i(o(e), t, n)
        } : i);
        ...
        return this._write(function(d) {
            ...
            return n.clone().primaryKeys().then(function(f) {
                ...
                return h(0).then(function() {
                    if (0 < u.length) throw new H("Error modifying one or more objects", u, s, t);
                    return f.length
                })
            })
        })
        ...
        return At(i) && (i.isPrimKey && !gt || 3 === n.type) ? this._write(function(e) {
            ...
            return i.table.core.count({
                ...
                return i.table.core.mutate({
                    ...
                    e = e.numFailures;
                    if (e) throw new H("Could not delete some values", Object.keys(t).map(function(e) {
                        return t[e]
                    }), n - e);
                    return n - e
                })
    ...
    var Qt = (Object.defineProperty(Xt.prototype, "Collection", {
        ...
        return null == e ? Lt(this, dt) : new this.Collection(this, function() {
            return Ht(e)
        })
        ...
        return "string" != typeof e ? Lt(this, pt) : this.between(e, e + ht, !0, !0)
        ...
        if (!e.every(function(e) {
            ...
            })) return Lt(this, "First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower", J.InvalidArgument);
    ...
    var Zt = "storagemutated",
        ...
        nn = (rn.prototype._lock = function() {
            ...
            })).onerror = Le(function(e) {
                $t(e), n._reject(t.error)
            }), t.onabort = Le(function(e) {
            ...
            return new je(function(t, n) {
                i.then(function(e) {
                    return r._waitingQueue.push(Le(t.bind(null, e)))
                }, function(e) {
                    return r._waitingQueue.push(Le(n.bind(null, e)))
                }).finally(function() {
            ...
            return {
                ...
                openCursor: function(e) {
                    ...
                    return new Promise(function(t, n) {
                        ...
                        s.onerror = Jt(n), s.onsuccess = Le(function(e) {
                            ...
                            u ? (u.___id = ++fn, u.done = !1, r = u.continue.bind(u), i = (i = u.continuePrimaryKey) && i.bind(u), o = u.advance.bind(u), a = function() {
                                ...
                                var n = new Promise(function(t, e) {
                                    t = Le(t), s.onerror = Jt(e), u.fail = e, u.stop = function(e) {
                                        u.stop = u.continue = u.continuePrimaryKey = u.advance = a, t(e)
                                    }
                                });
                                return s.onsuccess = Le(function(e) {
                                    s.onsuccess = t, t()
    ...
    function Cn(f) {
        ...
        return je.race([t, ("undefined" == typeof navigator ? je.resolve() : !navigator.userAgentData && /Safari\//.test(navigator.userAgent) && !/Chrom(e|ium)\//.test(navigator.userAgent) && indexedDB.databases ? new Promise(function(e) {
            ...
            return new je(function(s, n) {
                ...
                l.onerror = Jt(n), l.onblocked = Le(f._fireOnBlocked), l.onupgradeneeded = Le(function(e) {
                    var t;
                    d = l.transaction, h.autoSchema && !f._options.allowEmptyDB ? (l.onerror = $t, d.abort(), l.result.close(), (t = r.deleteDatabase(c)).onsuccess = t.onerror = Le(function() {
                    ...
                    yt.push(f), o.onversionchange = Le(function(e) {
                        h.vcFired = !0, f.on("versionchange").fire(e)
                    }), o.onclose = Le(function(e) {
                        f.on("close").fire(e)
    ...
    function In(i, o, a, u) {
        return a = a || {}, u = u || "", x(i).forEach(function(e) {
            var t, n, r;
            m(o, e) ? (t = i[e], n = o[e], "object" == typeof t && "object" == typeof n && t && n ? (r = j(t)) !== j(n) ? a[u + e] = o[e] : "Object" === r ? In(t, n, a, u + e + ".") : t !== n && (a[u + e] = o[e]) : t !== n && (a[u + e] = o[e])) : a[u + e] = void 0
                            ...
                            function a(c) {
                                ...
                                return "delete" !== (c = "add" === c.type || "put" === c.type ? g(g({}, c), {
                                    ...
                                    var s = f.map(function(e, t) {
                                        ...
                                        return "delete" === c.type ? h.fire.call(a, e, o, l) : "add" === c.type || void 0 === o ? (n = d.fire.call(a, e, c.values[t], l), null == e && null != n && (c.keys[t] = e = n, v.outbound || E(c.values[t], v.keyPath, e))) : (n = In(o, c.values[t]), (r = p.fire.call(a, n, e, o, l)) && (i = c.values[t], Object.keys(r).forEach(function(e) {
    ...
    var Gn = (Hn.prototype.version = function(t) {
        ...
        var s = function(i, o, a, u, s) {
            return je.resolve().then(function() {
                ...
                u ? t.idbtrans = u.idbtrans : t.create();
                var n, r = R(s);
                r && $e();
                e = je.follow(function() {
                    var e;
                    (n = s.call(t, t)) && (r ? (e = Ze.bind(null, null), n.then(e, e)) : "function" == typeof n.next && "function" == typeof n.throw && (n = jn(n)))
                }, e);
                return (n && "function" == typeof n.then ? je.resolve(n).then(function(e) {
                    return t.active ? e : lt(new J.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"))
                }) : e.then(function() {
                    return n
                })).then(function(e) {
                    return u && t._resolve(), t._completion.then(function() {
                        return e
                    })
                }).catch(function(e) {
    ...
    function Hn(e, t) {
        ...
        }, this.use(Bn), this.use(Tn), this.use(Yn), this.use(Fn), this.vip = Object.create(this, {
            _vip: {
                value: !0
            }
    ...
    var L = "undefined" != typeof Symbol && "observable" in Symbol ? Symbol.observable : "@@observable",
    ...
    r(Zn, g(g({}, W), {
        ...
        dependencies: nr,
        semVer: "3.2.0",
        version: "3.2.0".split(".").map(function(e) {
            return parseInt(e)
    ...
    return "undefined" != typeof BroadcastChannel ? (tr = new BroadcastChannel(en), tn(Zt, function(e) {
        ...
        return !e || e instanceof Y || e instanceof TypeError || e instanceof SyntaxError || !e.name || !$[e.name] ? e : (t = new $[e.name](t || e.message, e), "stack" in e && c(t, "stack", {
            get: function() {

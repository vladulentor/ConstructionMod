...
! function(e, t) {
    ...
    var d = function(n) {
            ...
            if (!i && (E(t), t = t || x, T)) {
                if (11 !== h && (l = te.exec(e)))
                    if (r = l[1]) {
                        ...
                        if ((r = l[3]) && d.getElementsByClassName && t.getElementsByClassName) return M.apply(n, t.getElementsByClassName(r)), n
                    }
        ...
        for (e in d = ae.support = {}, s = ae.isXML = function(e) {
                ...
                return i != x && 9 === i.nodeType && i.documentElement && (a = (x = i).documentElement, T = !s(x), b != x && (n = x.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)), d.scope = ue(function(e) {
                    return a.appendChild(e).appendChild(x.createElement("div")), void 0 !== e.querySelectorAll && !e.querySelectorAll(":scope fieldset div").length
                ...
                }, u = [], m = [], (d.qsa = ee.test(x.querySelectorAll)) && (ue(function(e) {
                    var t;
                    ...
                    d.disconnectedMatch = v.call(e, "*"), v.call(e, "[s!='']:x"), u.push("!=", B)
                ...
                if (E(e), d.matchesSelector && T && !N[t + " "] && (!u || !u.test(t)) && (!m || !m.test(t))) try {
                    var n = v.call(e, t);
        ...
        }, d.sortStable = C.split("").sort(D).join("") === C, d.detectDuplicates = !!c, E(), d.sortDetached = ue(function(e) {
    ...
    C.event = {
        ...
        add: function(t, e, n, i, r) {
            ...
            if (Q(t))
                for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(ie, r), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = Object.create(null)), (s = m.handle) || (s = m.handle = function(e) {
                    ...
                    }), c = (e = (e || "").match(M) || [""]).length; c--;) d = g = (a = Ee.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), d && (f = C.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {}, u = C.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && A(t, "input") && Ae(t, "click", xe), !1
                },
                trigger: function(e) {
                    var t = this || e;
    ...
    function Me(n, i, r, o) {
        ...
        if (f && (t = (e = be(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)
                for (c = s[s.length - 1].ownerDocument, C.map(s, Le), u = 0; u < a; u++) l = s[u], de.test(l.type || "") && !X.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
    ...
    function Xe(e, t, n) {
        ...
        return (n = n || Qe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = C.style(e, t)), !y.pixelBoxStyles() && Ue.test(s) && Ye.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    $e = T.createElement("div"), (Ve = T.createElement("div")).style && (Ve.style.backgroundClip = "content-box", Ve.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Ve.style.backgroundClip, C.extend(y, {
        ...
        reliableTrDimensions: function() {
            var e, t, n, i;
            return null == Be && (e = T.createElement("table"), t = T.createElement("tr"), n = T.createElement("div"), e.style.cssText = "position:absolute;left:-11111px", t.style.height = "1px", n.style.height = "9px", ie.appendChild(e).appendChild(t).appendChild(n), i = x.getComputedStyle(t), Be = 3 < parseInt(i.height), ie.removeChild(e)), Be
        }
    }));
    ...
    C.extend({
        ...
        css: function(e, t, n, i) {
            var r, o, s, a = U(t);
            return rt.test(t) || (t = nt(a)), (s = C.cssHooks[t] || C.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Xe(e, t, i)), "normal" === r && t in st && (r = st[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), C.each(["height", "width"], function(e, l) {
        C.cssHooks[l] = {
            get: function(e, t, n) {
                if (t) return !it.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, l, n) : Pe(e, ot, function() {
                    return ct(e, l, n)
                })
            },
            set: function(e, t, n) {
    ...
    function vt() {
        ht && (!1 === T.hidden && x.requestAnimationFrame ? x.requestAnimationFrame(vt) : x.setTimeout(vt, C.fx.interval), C.fx.tick())
    }
    ...
    function wt(o, e, t) {
        ...
        return C.map(u, _t, c), b(c.opts.start) && c.opts.start.call(o, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), C.fx.timer(C.extend(l, {
            elem: o,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    C.Animation = C.extend(wt, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, r = (e = b(e) ? (t = e, ["*"]) : e.match(M)).length; i < r; i++) n = e[i], wt.tweeners[n] = wt.tweeners[n] || [], wt.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = X.get(e, "display")), "none" === (u = C.css(e, "display")) && (c ? u = c : (ce([e], !0), c = e.style.display || c, u = C.css(e, "display"), ce([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === C.css(e, "float") && (l || (h.done(function() {
                        p.display = c
                    ...
                    for (i in g || ce([e]), X.remove(e, "fxshow"), d) C.style(e, i, d[i])
                })), l = _t(g ? m[i] : 0, i, h), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
        }],
    ...
    C.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? Et : void 0)), void 0 !== n ? null === n ? void C.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : !(r && "get" in r && null !== (i = r.get(e, t))) && null == (i = C.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    Yt.href = jt.href, C.extend({
        ...
        ajax: function(e, t) {
            ...
            if (b.promise(E), m.url = ((e || m.url || jt.href) + "").replace($t, jt.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(M) || [""], null == m.crossDomain) {
                i = T.createElement("a");
                try {
    ...
    C.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(nn, "$1" + i) : !1 !== e.jsonp && (e.url += (It.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
            ...
            void 0 === r ? C(x).removeProp(i) : x[i] = r, e[i] && (e.jsonpCallback = t.jsonpCallback, tn.push(i)), o && b(r) && r(o[0]), o = r = void 0
        }), "script"
        ...
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((i = (t = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href, t.head.appendChild(i)) : t = T), o = !n && [], (r = k.exec(e)) ? [t.createElement(r[1])] : (r = be([e], t, o), o && o.length && C(o).remove(), C.merge([], r.childNodes)));
        var i, r, o
    ...
    }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = A, C.isFunction = b, C.isWindow = g, C.camelCase = U, C.type = w, C.now = Date.now, C.isNumeric = function(e) {
        var t = C.type(e);
    ...
    return C.noConflict = function(e) {
        return x.$ === C && (x.$ = sn), e && x.jQuery === C && (x.jQuery = on), C
...
function(e, t) {
    ...
    p(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', l._handleDismiss(new l)), p.fn[r] = l._jQueryInterface, p.fn[r].Constructor = l, p.fn[r].noConflict = function() {
        return p.fn[r] = a, l._jQueryInterface
    };
    var u, f = p.fn.button,
    ...
    p(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(e) {
        ...
        if (p(t).hasClass("btn") || (t = p(t).closest(".btn")[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault();
            ...
            "LABEL" === n.tagName && i && "checkbox" === i.type && e.preventDefault(), h._jQueryInterface.call(p(t), "toggle")
        }
    ...
    }), p.fn.button = h._jQueryInterface, p.fn.button.Constructor = h, p.fn.button.noConflict = function() {
        return p.fn.button = f, h._jQueryInterface
    };
    var m, v = "carousel",
        y = p.fn[v],
        b = {
        ...
        E = ((m = x.prototype).next = function() {
            ...
            return e = s(s({}, b), e), g.typeCheckConfig(v, e, _), e
            ...
            u && p(u).hasClass("active") ? this._isSliding = !1 : !this._triggerSlideEvent(u, d).isDefaultPrevented() && l && u && (this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(u), r = p.Event("slid.bs.carousel", {
                relatedTarget: u,
                direction: d,
                from: c,
                to: f
            }), p(this._element).hasClass("slide") ? (p(u).addClass(i), g.reflow(u), p(l).addClass(n), p(u).addClass(n), (o = parseInt(u.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, this._config.interval = o) : this._config.interval = this._config.defaultInterval || this._config.interval, s = g.getTransitionDurationFromElement(l), p(l).one(g.TRANSITION_END, function() {
            ...
            }).emulateTransitionEnd(s)) : (p(l).removeClass("active"), p(u).addClass("active"), this._isSliding = !1, p(this._element).trigger(r)), h && this.cycle())
            ...
            !r || (t = p(r)[0]) && p(t).hasClass("carousel") && (n = s(s({}, p(t).data()), p(this).data()), (i = this.getAttribute("data-slide-to")) && (n.interval = !1), x._jQueryInterface.call(p(t), n), i && p(t).data("bs.carousel").to(i), e.preventDefault())
        }, o(x, null, [{
            key: "VERSION",
            get: function() {
                return "4.5.0"
    ...
    }), p.fn[v] = E._jQueryInterface, p.fn[v].Constructor = E, p.fn[v].noConflict = function() {
        return p.fn[v] = y, E._jQueryInterface
    };
    var T, C = "collapse",
        S = p.fn[C],
        A = {
        ...
        O = ((T = N.prototype).toggle = function() {
            ...
            })).length && (e = null), e && (t = p(e).not(this._selector).data("bs.collapse")) && t._isTransitioning) || (n = p.Event("show.bs.collapse"), p(this._element).trigger(n), n.isDefaultPrevented() || (e && (N._jQueryInterface.call(p(e).not(this._selector), "hide"), t || p(e).data("bs.collapse", null)), i = this._getDimension(), p(this._element).removeClass("collapse").addClass("collapsing"), this._element.style[i] = 0, this._triggerArray.length && p(this._triggerArray).removeClass("collapsed").attr("aria-expanded", !0), this.setTransitioning(!0), r = "scroll" + (i[0].toUpperCase() + i.slice(1)), o = g.getTransitionDurationFromElement(this._element), p(this._element).one(g.TRANSITION_END, function() {
            ...
            return (e = s(s({}, A), e)).toggle = Boolean(e.toggle), g.typeCheckConfig(C, e, k), e
    ...
    }), p.fn[C] = O._jQueryInterface, p.fn[C].Constructor = O, p.fn[C].noConflict = function() {
        return p.fn[C] = S, O._jQueryInterface
    };
    ...
    function te(e) {
        var t, n, i = {};
        try {
            F(10) ? (i = e.getBoundingClientRect(), t = V(e, "top"), n = V(e, "left"), i.top += t, i.left += n, i.bottom += t, i.right += n) : i = e.getBoundingClientRect()
        } catch (e) {}
        var r, o = {
                left: i.left,
                top: i.top,
    ...
    function re(e, t, n, i, r) {
        ...
        }(h, u) : (o = void 0, "scrollParent" === i ? "BODY" === (o = P(R(t))).nodeName && (o = e.ownerDocument.documentElement) : o = "window" === i ? e.ownerDocument.documentElement : i, s = ne(o, h, u), "HTML" !== o.nodeName || function e(t) {
            var n = t.nodeName;
            if ("BODY" === n || "HTML" === n) return !1;
            if ("fixed" === M(t, "position")) return !0;
            var i = R(t);
            return !!i && e(i)
        }(h) ? f = s : (l = (a = Y(e.ownerDocument)).height, c = a.width, f.top += s.top - s.marginTop, f.bottom = l + s.top, f.left += s.left - s.marginLeft, f.right = c + s.left));
    ...
    function ve(n, i) {
        Object.keys(i).forEach(function(e) {
            var t = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && me(i[e]) && (t = "px"), n.style[e] = i[e] + t
        })
    }
            ...
            modifiers: {
                ...
                computeStyle: {
                    ...
                    fn: function(e, t) {
                        ...
                        var s, a, l, c, u, f, h, d, p, g, m, v, y, b, _, w, E, x = void 0 !== o ? o : t.gpuAcceleration,
                            ...
                            A = (l = e, c = window.devicePixelRatio < 2 || !ye, u = l.offsets, f = u.popper, h = u.reference, d = Math.round, p = Math.floor, g = d(h.width), m = d(f.width), v = -1 !== ["left", "right"].indexOf(l.placement), y = -1 !== l.placement.indexOf("-"), _ = c ? d : D, {
                ...
                applyStyle: {
                    ...
                    onLoad: function(e, t, n, i, r) {
                        ...
                        return t.setAttribute("x-placement", s), ve(t, {
            ...
            value: function() {
                return function() {
                    ...
                    this.state.isDestroyed || ((e = {
                        ...
                        flipped: !1,
                        offsets: {}
                    }).offsets.reference = se(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = oe(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = ce(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = fe(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e)))
                }.call(this)
            }
        }, {
            key: "destroy",
    ...
    function Ce(e, t) {
        ...
        G(this, Ce), this.scheduleUpdate = function() {
            return requestAnimationFrame(n.update)
        }, this.update = L(this.update.bind(this)), this.options = J({}, Ce.Defaults, i), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(J({}, Ce.Defaults.modifiers, i.modifiers)).forEach(function(e) {
    ...
    var Se, Ae = "dropdown",
        ...
        je = ((Se = Le.prototype).toggle = function() {
            ...
            if (void 0 === e && (e = !1), !(this._element.disabled || p(this._element).hasClass("disabled") || p(this._menu).hasClass("show"))) {
                ...
                if (p(i).trigger(n), !n.isDefaultPrevented()) {
                    if (!this._inNavbar && e) {
                        ...
                        var r = this._element;
                        "parent" === this._config.reference ? r = i : g.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(i).addClass("position-static"), this._popper = new Te(r, this._menu, this._getPopperConfig())
                    }
            ...
            this._element.disabled || p(this._element).hasClass("disabled") || !p(this._menu).hasClass("show") || (e = {
                relatedTarget: this._element
            }, t = p.Event("hide.bs.dropdown", e), n = Le._getParentFromElement(this._element), p(n).trigger(t), t.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass("show"), p(n).toggleClass("show").trigger(p.Event("hidden.bs.dropdown", e))))
        }, Se.dispose = function() {
            ...
            return e = s(s(s({}, this.constructor.Default), p(this._element).data()), e), g.typeCheckConfig(Ae, e, this.constructor.DefaultType), e
        }, Se._getMenuElement = function() {
            var e;
            return this._menu || (e = Le._getParentFromElement(this._element)) && (this._menu = e.querySelector(".dropdown-menu")), this._menu
    ...
    p(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', je._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", je._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", je._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(e) {
        ...
        e.stopPropagation()
    }), p.fn[Ae] = je._jQueryInterface, p.fn[Ae].Constructor = je, p.fn[Ae].noConflict = function() {
        return p.fn[Ae] = ke, je._jQueryInterface
    };
    var Ie, Me = p.fn.modal,
        ...
        qe = ((Ie = He.prototype).toggle = function(e) {
            ...
            var t, n = this;
            this._isShown || this._isTransitioning || (p(this._element).hasClass("fade") && (this._isTransitioning = !0), t = p.Event("show.bs.modal", {
                relatedTarget: e
            }), p(this._element).trigger(t), this._isShown || t.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(e) {
                return n.hide(e)
            ...
            var t, n, i, r = this;
            e && e.preventDefault(), this._isShown && !this._isTransitioning && (t = p.Event("hide.bs.modal"), p(this._element).trigger(t), this._isShown && !t.isDefaultPrevented() && (this._isShown = !1, (n = p(this._element).hasClass("fade")) && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off("focusin.bs.modal"), p(this._element).removeClass("show"), p(this._element).off("click.dismiss.bs.modal"), p(this._dialog).off("mousedown.dismiss.bs.modal"), n ? (i = g.getTransitionDurationFromElement(this._element), p(this._element).one(g.TRANSITION_END, function(e) {
            ...
            return e = s(s({}, Re), e), g.typeCheckConfig("modal", e, Pe), e
            ...
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", r && this._backdrop.classList.add(r), p(this._backdrop).appendTo(document.body), p(this._element).on("click.dismiss.bs.modal", function(e) {
                        i._ignoreBackdropClick ? i._ignoreBackdropClick = !1 : e.target === e.currentTarget && i._triggerBackdropTransition()
                    }), r && g.reflow(this._backdrop), p(this._backdrop).addClass("show"), !e) return;
                if (!r) return void e();
                var o = g.getTransitionDurationFromElement(this._backdrop);
                p(this._backdrop).one(g.TRANSITION_END, e).emulateTransitionEnd(o)
            } else !this._isShown && this._backdrop ? (p(this._backdrop).removeClass("show"), t = function() {
                i._removeBackdrop(), e && e()
            }, p(this._element).hasClass("fade") ? (n = g.getTransitionDurationFromElement(this._backdrop), p(this._backdrop).one(g.TRANSITION_END, t).emulateTransitionEnd(n)) : t()) : e && e()
    ...
    }), p.fn.modal = qe._jQueryInterface, p.fn.modal.Constructor = qe, p.fn.modal.noConflict = function() {
        return p.fn.modal = Me, qe._jQueryInterface
    };
    ...
    var $e, Ve = "tooltip",
        ...
        Ze = (($e = et.prototype).enable = function() {
            ...
            function t() {
                "show" !== i._hoverState && r.parentNode && r.parentNode.removeChild(r), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), p(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), e && e()
            }
            var n, i = this,
            ...
            "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = ze(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text())
        }, $e.getTitle = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                ...
                "click" === e ? p(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(e) {
                    return i.toggle(e)
                }) : "manual" !== e && (t = "hover" === e ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN, n = "hover" === e ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT, p(i.element).on(t, i.config.selector, function(e) {
                    return i._enter(e)
            ...
            return Object.keys(t).forEach(function(e) {
                ...
                show: e.delay,
                hide: e.delay
            }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), g.typeCheckConfig(Ve, e, this.constructor.DefaultType), e.sanitize && (e.template = ze(e.template, e.whiteList, e.sanitizeFn)), e
    ...
    p.fn[Ve] = Ze._jQueryInterface, p.fn[Ve].Constructor = Ze, p.fn[Ve].noConflict = function() {
        return p.fn[Ve] = Ue, Ze._jQueryInterface
    };
    var tt = "popover",
        nt = p.fn[tt],
    ...
    p.fn[tt] = at._jQueryInterface, p.fn[tt].Constructor = at, p.fn[tt].noConflict = function() {
        return p.fn[tt] = nt, at._jQueryInterface
    };
    var lt, ct = "scrollspy",
        ut = p.fn[ct],
        ft = {
        ...
        dt = ((lt = pt.prototype).refresh = function() {
            ...
            var t;
            return "string" != typeof(e = s(s({}, ft), "object" == typeof e && e ? e : {})).target && g.isElement(e.target) && ((t = p(e.target).attr("id")) || (t = g.getUID(ct), p(e.target).attr("id", t)), e.target = "#" + t), g.typeCheckConfig(ct, e, ht), e
    ...
    }), p.fn[ct] = dt._jQueryInterface, p.fn[ct].Constructor = dt, p.fn[ct].noConflict = function() {
        return p.fn[ct] = ut, dt._jQueryInterface
    };
    var gt, mt = p.fn.tab,
    ...
    p(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(), vt._jQueryInterface.call(p(this), "show")
    }), p.fn.tab = vt._jQueryInterface, p.fn.tab.Constructor = vt, p.fn.tab.noConflict = function() {
        return p.fn.tab = mt, vt._jQueryInterface
    };
    var bt, _t = p.fn.toast,
        ...
        xt = ((bt = Tt.prototype).show = function() {
            ...
            }, this._element.classList.remove("hide"), g.reflow(this._element), this._element.classList.add("showing"), this._config.animation ? (t = g.getTransitionDurationFromElement(this._element), p(this._element).one(g.TRANSITION_END, e).emulateTransitionEnd(t)) : e())
        }, bt.hide = function() {
            var e;
            ...
            return e = s(s(s({}, Et), p(this._element).data()), "object" == typeof e && e ? e : {}), g.typeCheckConfig("toast", e, this.constructor.DefaultType), e
    ...
    p.fn.toast = xt._jQueryInterface, p.fn.toast.Constructor = xt, p.fn.toast.noConflict = function() {
        return p.fn.toast = _t, xt._jQueryInterface
    }, e.Alert = l, e.Button = h, e.Carousel = E, e.Collapse = O, e.Dropdown = je, e.Modal = qe, e.Popover = at, e.Scrollspy = dt, e.Tab = vt, e.Toast = xt, e.Tooltip = Ze, e.Util = g, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function(e, t) {
    ...
    function te(c) {
        return function(e, t, n) {
            ...
            if (c && t != t) {
                ...
                for (; l < a; l++)
                    if ((c || l in s) && s[l] === t) return c || l || 0;
            return !c && -1
        }
    }
    ...
    function ce(e, t) {
        var n;
        return Le(e) && ("function" == typeof(n = e.constructor) && (n === Array || Le(n.prototype)) || v(n) && null === (n = n[Pe])) && (n = void 0), new(void 0 === n ? Array : n)(0 === t ? 0 : t)
    }
    ...
    w = V ? (c = new G, d = c.get, p = c.has, g = c.set, y = function(e, t) {
        return g.call(c, e, t), t
    }, _ = function(e) {
        return d.call(c, e) || {}
    }, function(e) {
        return p.call(c, e)
    }) : (E = s("state"), X[E] = !0, y = function(e, t) {
        return F(e, E, t), t
    }, _ = function(e) {
        return f(e, E) ? e[E] : {}
    }, function(e) {
    ...
    var he = {
            ...
            getterFor: function(n) {
                return function(e) {
                    var t;
                    if (!v(e) || (t = _(e)).type !== n) throw TypeError("Incompatible receiver, " + n + " required");
                    return t
                }
            }
        },
    ...
    var Ge = Object.keys || function(e) {
        ...
        Ke = S ? Object.defineProperties : function(e, t) {
            x(e);
            for (var n, i = Ge(t), r = i.length, o = 0; o < r;) W.f(e, n = i[o++], t[n]);
            return e
        },
        ...
        nt = Object.create || function(e, t) {
            var n;
            return null !== e ? (Xe[et] = x(e), n = new Xe, Xe[et] = null, n[Ze] = e) : n = tt(), void 0 === t ? n : Ke(n, t)
        };
    X[Ze] = !0;
    ...
    var st, at, lt, ct = {},
        ...
        ft = s("IE_PROTO"),
        ht = Object.prototype,
        dt = ut ? Object.getPrototypeOf : function(e) {
    ...
    function bt(e, t, n, i, r, o, s) {
        ...
        l = t + " Iterator", (a = n).prototype = nt(xt, {
            next: b(1, i)
        }), mt(a, l, !1), ct[l] = vt;
        ...
        if (y && (u = dt(y.call(new e)), Ct !== Object.prototype && u.next && (dt(u) !== Ct && (Tt ? Tt(u, Ct) : "function" != typeof u[At] && F(u, At, yt)), mt(u, d, !0))), r == kt && m && m.name !== kt && (p = !0, v = function() {
                return m.call(this)
            }), g[At] !== v && F(g, At, v), ct[t] = v, r)
            if (f = {
                    values: c(kt),
                    keys: o ? v : c("keys"),
                    entries: c(Ot)
        ...
        return f
    }[].keys && ("next" in (lt = [].keys()) ? (at = dt(dt(lt))) !== Object.prototype && (st = at) : gt = !0), null == st && (st = {}), f(st, pt) || F(st, pt, function() {
        return this
    });
    var _t = {
    ...
    function Bt(n) {
        return function(e) {
            var t = String(l(e));
            return 1 & n && (t = t.replace(Vt, "")), 2 & n && (t = t.replace(Ut, "")), t
        }
    }
        ...
        an = t(function(e) {
            ...
            var t = W.f,
                ...
                s = e.exports = {
                    ...
                    onFreeze: function(e) {
                        return sn && s.REQUIRED && o(e) && !f(e, i) && n(e), e
                    }
                };
            X[i] = !0
        }),
            ...
            function h(e, t) {
                ...
                if (r) o = e;
                    ...
                    if ("function" != typeof(s = function() {
                            if (null != e) return e[un] || e["@@iterator"] || ct[Rt(e)]
                ...
                for (; !(u = o.next()).done;)
                    if ((c = function(e, t, n, i) {
                        ...
                        }(o, f, u.value, i)) && c instanceof h) return c;
                return new h(!1)
            }).stop = function(e) {
                return new h(!0, e)
            }
    ...
    function mn(s, e, t, a, i) {
        ...
        return De(s, "function" != typeof f || !(i || h.forEach && !m(function() {
            (new f).entries().next()
        }))) ? (d = t.getConstructor(e, s, a, p), an.REQUIRED = !0) : De(s, !0) && (o = (r = new d)[p](i ? {} : -0, 1) != r, l = m(function() {
            r.has(1)
        }), c = function() {
            if (!dn) return !1;
            var e = !1;
            ...
            on(e, d, s);
            var n, i, r, o = (n = new f, Tt && "function" == typeof(i = e.constructor) && i !== d && v(r = i.prototype) && r !== d.prototype && Tt(n, r), n);
            return null != t && fn(t, o[p], o, a), o
        })).prototype = h).constructor = d), (l || u) && (n("delete"), n("has"), a && n("get")), (u || o) && n(p), i && h.clear && delete h.clear), re({
            global: !0,
            forced: (g[s] = d) != f
        }, g), mt(d, s), i || t.setStrong(d, s, a), d
    }
    ...
    var Sn = {
        ...
        An = (t(function(e) {
            ...
            V && c && (i = Sn.getConstructor(t, "WeakMap", !0), an.REQUIRED = !0, n = f.prototype, r = n.delete, o = n.has, s = n.get, a = n.set, rn(n, {
                delete: function(e) {
                    if (!v(e) || u(e)) return r.call(this, e);
                    var t = l(this);
                    return t.frozen || (t.frozen = new i), r.call(this, e) || t.frozen.delete(e)
                },
                has: function(e) {
                    if (!v(e) || u(e)) return o.call(this, e);
                    var t = l(this);
                    return t.frozen || (t.frozen = new i), o.call(this, e) || t.frozen.has(e)
                },
                get: function(e) {
                    if (!v(e) || u(e)) return s.call(this, e);
                    var t = l(this);
                    return t.frozen || (t.frozen = new i), o.call(this, e) ? s.call(this, e) : t.frozen.get(e)
                },
                set: function(e, t) {
                    var n;
                    return v(e) && !u(e) ? ((n = l(this)).frozen || (n.frozen = new i), o.call(this, e) ? a.call(this, e, t) : n.frozen.set(e, t)) : a.call(this, e, t), this
                }
            }))
        }), le("iterator")),
        kn = le("toStringTag"),
                ...
                function(i, r, e) {
                    ...
                    function v() {
                        ...
                        if (o = arguments, s = this, c = t, n) {
                            if (void 0 === l) return u = e = c, l = setTimeout(g, r), f ? d(e) : a;
                            if (h) return l = setTimeout(g, r), d(c)
                        }
                        return void 0 === l && (l = setTimeout(g, r)), a
                    }
                    return r = Gn(r) || 0, Xn(e) && (f = !!e.leading, n = (h = "maxWait" in e) ? Qn(Gn(e.maxWait) || 0, r) : n, t = "trailing" in e ? !!e.trailing : t), v.cancel = function() {
    ...
    var hi, di = function(i, r, e) {
            ...
            return r = fi(r) || 0, ui(e) && (f = !!e.leading, n = (h = "maxWait" in e) ? li(fi(e.maxWait) || 0, r) : n, t = "trailing" in e ? !!e.trailing : t), v.cancel = function() {
                void 0 !== l && clearTimeout(l), o = c = s = l = void(u = 0)
            }, v.flush = function() {
    ...
    Ii.prototype.clear = function() {
        ...
        return this.__data__[e] = Li && void 0 === t ? gi : t, this
    ...
    var Bi = Wi,
        ...
        Xi = (Gi.prototype.addObserver = function(e) {
            ...
            $i && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), Yi ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
                attributes: !0,
                childList: !0,
                characterData: !0,
                subtree: !0
    ...
    function sr(e) {
        this.broadcastWidth = 0, this.broadcastHeight = 0, this.contentRect_ = rr(0, 0, 0, 0), this.target = e
    }

    function ar(e, t) {
        var n, i, r, o, s, a, l = (n = t.x, i = t.y, r = t.width, o = t.height, s = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, a = Object.create(s.prototype), Ki(a, {
            x: n,
            y: i,
            width: r,
            height: o,
    ...
    Ue && window.addEventListener("resize", function() {
        pr !== window.devicePixelRatio && (pr = window.devicePixelRatio, dr = null)
    });
    var vr = [mr(!1), mr(!0)][0];
    re({
        target: "Array",
    ...
    (Ar || kr) && (Sr = function(e) {
        ...
        }.call(this))), Ar && (t = this.lastIndex), i = Tr.call(this, e), Ar && i && (this.lastIndex = this.global ? i.index + i[0].length : t), kr && i && 1 < i.length && Cr.call(i[0], n, function() {
    ...
    function Nr(n, e, t, i) {
        var o, r, s, a, l = le(n),
            ...
            u = c && !m(function() {
                ...
                return t.exec = function() {
                    return e = !0, null
                }, "split" === n && (t.constructor = {}, t.constructor[Lr] = function() {
                    return t
                }), t[l](""), !e
            });
        c && u && ("replace" !== n || Ir) && ("split" !== n || Mr) || (o = /./ [l], s = (r = t(l, "" [n], function(e, t, n, i, r) {
        ...
        }))[0], a = r[1], de(String.prototype, n, s), de(RegExp.prototype, l, 2 == e ? function(e, t) {
    ...
    Nr("match", 1, function(i, c, u) {
        return [function(e) {
            ...
            for (var r, o = n.unicode, s = [], a = n.lastIndex = 0; null !== (r = jr(n, i));) {
                var l = String(r[0]);
                "" === (s[a] = l) && (n.lastIndex = Dr(i, ee(n.lastIndex), o)), a++
            }
            return 0 === a ? null : s
        }]
    });
    ...
    var Vr = function() {
        function l(e, t) {
            ...
            }, this.removePreventClickId = null, l.instances.has(this.el) || (this.recalculate = Jn(this.recalculate.bind(this), 64), this.onMouseMove = Jn(this.onMouseMove.bind(this), 64), this.hideScrollbars = di(this.hideScrollbars.bind(this), this.options.timeout), this.onWindowResize = di(this.onWindowResize.bind(this), 64, {
                leading: !0
            }), l.getRtlHelpers = Bi(l.getRtlHelpers), this.init())
        }
        ...
        return e.init = function() {
            l.instances.set(this.el, this), Ue && (this.initDOM(), this.scrollbarWidth = this.getScrollbarWidth(), this.recalculate(), this.initListeners())
        }, e.initDOM = function() {
            var e, t, n = this;
            ...
            void 0 === i && (i = "y"), this.options.clickOnTrack && (r = zr(this.el), this.axis[i].scrollbar.rect = this.axis[i].scrollbar.el.getBoundingClientRect(), t = this.axis[i].scrollbar.rect[this.axis[i].offsetAttr], n = parseInt(this.elStyles[this.axis[i].sizeAttr], 10), o = this.contentWrapperEl[this.axis[i].scrollOffsetAttr], s = ("y" === i ? this.mouseY - t : this.mouseX - t) < 0 ? -1 : 1, a = -1 == s ? o - n : o + n, function e() {
                var t, n; - 1 == s ? a < o && (o -= 40, l.contentWrapperEl.scrollTo(((t = {})[l.axis[i].offsetAttr] = o, t)), r.requestAnimationFrame(e)) : o < a && (o += 40, l.contentWrapperEl.scrollTo(((n = {})[l.axis[i].offsetAttr] = o, n)), r.requestAnimationFrame(e))
            }())
    ...
    }, Vr.getOptions = Br, Ue && Vr.initHtmlApi(), Vr
}),
function(e) {

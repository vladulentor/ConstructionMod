    ...
    PetiteVue = function(e) {
        ...
        class W {
            ...
            run() {
                ...
                if (!T.includes(this)) try {
                    return T.push(M = this), F.push(V), V = !0, R = 1 << ++P, P <= 30 ? (({
                        deps: e
                    }) => {
                        if (e.length)
                            for (let t = 0; t < e.length; t++) e[t].w |= R
                    })(this) : I(this), this.fn()
                } finally {
                    P <= 30 && (e => {
                        const {
                        ...
                        if (t.length) {
                            ...
                            for (let s = 0; s < t.length; s++) {
                                const r = t[s];
                                j(r) && !A(r) ? r.delete(e) : t[n++] = r, r.w &= ~R, r.n &= ~R
                            }
                            t.length = n
                        }
                    })(this), R = 1 << --P, z(), T.pop();
        ...
        function H(e, t, n) {
            ...
            r || s.set(n, r = E()),
                function(e, t) {
                    let n = !1;
                    P <= 30 ? A(e) || (e.n |= R, n = !j(e)) : n = !e.has(M), n && (e.add(M), M.deps.push(e))
                }(r)
        }
        ...
        function Z(e, t) {
            for (const n of a(e) ? e : [...e])(n !== M || n.allowRecurse) && (n.scheduler ? n.scheduler() : n.run())
        }
        const q = function(e, t) {
            ...
            D = new Set(Object.getOwnPropertyNames(Symbol).map((e => Symbol[e])).filter(m)),
            G = X(),
            U = X(!0),
            Q = function() {
                const e = {};
        ...
        const ae = [],
            ...
            ve = ({
                ...
                "class" === s && (e._class = e.className), n((() => {
                    let n = t();
                    if (s)(null == r ? void 0 : r.camel) && (s = _(s)), ye(e, s, n, i);
                    else {
                ...
                if ("class" === n) e.setAttribute("class", i(e._class ? [e._class, s] : s) || "");
                    ...
                    if (s)
                        if (d(s)) s !== r && (n.cssText = s);
                            ...
                            if (r && !d(r))
                                for (const e in r) null == s[e] && xe(n, e, "")
                        }
            ...
            $e = /^[A-Za-z_$][\w$]*(?:\.[A-Za-z_$][\w$]*|\['[^']*?']|\["[^"]*?"]|\[\d+]|\[[A-Za-z_$][\w$]*])*$/,
            ...
            Pe = e => {
                const t = e.target;
                t.composing && (t.composing = !1, Re(t, "input"))
            },
            Re = (e, t) => {
            ...
            We = {
                ...
                model: ({
                    ...
                    if ("SELECT" === e.tagName) {
                        ...
                        _e(e, "compositionstart", Ne), _e(e, "compositionend", Pe), _e(e, (null == r ? void 0 : r.lazy) ? "change" : "input", (() => {
            ...
            ze = (e, t, n) => {
                ...
                const c = s[2].trim();
                let l, f, u, p, h = s[1].trim().replace(Ve, "").trim(),
                    d = !1,
                    m = "key",
                    v = e.getAttribute(m) || e.getAttribute(m = ":key") || e.getAttribute(m = "v-bind:key");
                ...
                return n.effect((() => {
                    ...
                    if ([b, x] = (e => {
                            const t = new Map,
                                n = [];
                            if (a(e))
                                for (let s = 0; s < e.length; s++) n.push(_(t, e[s], s));
                            else if ("number" == typeof e)
                                for (let s = 0; s < e; s++) n.push(_(t, s + 1, s));
                            else if (g(e)) {
                                let s = 0;
                                for (const r in e) n.push(_(t, e[r], s++, r))
                            }
                            return [n, t]
                        })(e), w) {
        ...
        const De = (e, t) => {
                ...
                if (1 === n) {
                    ...
                    let s;
                    if (we(n, "v-cloak"), s = we(n, "v-if")) return ((e, t, n) => {
                        const s = e.parentNode,
                            r = new Text(""),
                            i = new Comment("v-if");
                        s.insertBefore(r, e), s.insertBefore(i, r);
                        const o = [{
                            exp: t,
                            el: e
                        }];
                        let c, l;
                        for (;
                            (c = e.nextElementSibling) && (l = null, "" === we(c, "v-else") || (l = we(c, "v-else-if")));) s.removeChild(c), o.push({
                            exp: l,
                            el: c
                        });
                        ...
                        let u, a = -1;
                        const p = () => {
                            u && (r.parentNode.insertBefore(i, u.el), u.remove(), u = void 0)
                        };
                        return n.effect((() => {
                            for (let e = 0; e < o.length; e++) {
                                ...
                                if (!t || Me(n.scope, t)) {
                                    if (e !== a) {
                                        ...
                                        u.insert(t, r), t.removeChild(i), a = e
                                    }
                                    return
                                }
                            }
                    ...
                    if (s = we(n, "v-for")) return ze(n, s, t);
                    if ((s = we(n, "v-scope")) || "" === s) {
                        const e = s ? Me(t.scope, s) : {};
                        t = et(t, e), e.$template && Xe(n, e.$template)
                    }
                    const r = null != we(n, "v-once");
                    r && (qe = !0), (s = we(n, "ref")) && Qe(n, He, `"${s}"`, t), Ge(n, t);
                    const i = [];
                    for (const {
                            name: e,
                            value: o
                        } of [...n.attributes]) Je.test(e) && "v-cloak" !== e && ("v-model" === e ? i.unshift([e, o]) : "@" === e[0] || /^v-on\b/.test(e) ? i.push([e, o]) : Ue(n, e, o, t));
            ...
            rt = e => {
                ...
                return t.scope.$s = Ce, t.scope.$nextTick = he, t.scope.$refs = Object.create(null), {
                    ...
                    mount(e) {
                        ...
                        let s;
                        return s = (e = e || document.documentElement).hasAttribute("v-scope") ? [e] : [...e.querySelectorAll("[v-scope]")].filter((e => !e.matches("[v-scope] [v-scope]"))), s.length || (s = [e]), n = s.map((e => new nt(e, t, !0))), this
                    },
                    unmount() {
